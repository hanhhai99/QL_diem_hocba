...
namespace QLdiem_hocba.Chucnang
{
    public partial class Themgv : Form
    {
        ...
        public Themgv()
        {
            ...
            DataTable data = nhanvien.lay_to();
            for (int i = 0; i < data.Rows.Count; i++)
            {
                cbto.Items.Add(data.Rows[i][0].ToString());
            }
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            else if(nhanvien.kiemtra_mataikhoan(tbma.Text) == 0)
            {
                ...
                nhanvien.Tao_tk(tbma.Text, tbten.Text, tbmk.Text, "GV",
                                tbtenhs.Text, date, cbgioitinh.Text);
                nhanvien.Tao_gv(tbma.Text, cbto.Text, "");
